...
public class EndLuminophorBlock extends EndBlock implements BlockItemProvider, IBlockTool {
	private static final String[] VARIANTS = new String[] {
		"mossy_glowshroom_hymenophore",
		"glowing_pillar_luminophor"
	};
	
	public EndLuminophorBlock(String name, int id) {
		super(name, id, Material.PLANT);
		this.setLightEmittance(1);
